...
class LoggingConfig:
    ...
    def _configure_logging(self):
        ...
        loggers = {
            ...
            "fastapi": log_level,
            "celery": log_level,
            "chrona": log_level,  # For general app logging
        ...
        for logger_name, level in loggers.items():
            ...
            if logger_name in ["chrona", "app", "celery"]:
    ...
    def logger(self) -> logging.Logger:
        ...
        return logging.getLogger("chrona")
...
def get_logger(name: str = "chrona") -> logging.Logger:
    """Get a logger instance with the given name."""
