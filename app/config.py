...
DEFAULT_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/chrona"
DEFAULT_TEST_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/chrona_test"
